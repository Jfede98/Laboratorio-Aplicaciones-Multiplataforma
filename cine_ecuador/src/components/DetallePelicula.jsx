...
{/* aquí están los botones de los horarios de cada película */}
    <p><strong>Horario de funciones:</strong></p> 
    <div className="d-flex flex-wrap gap-2">
      {pelicula.funciones[0].hora.map((horario, index) => (
        <button key={index} className="btn btn-outline-primary btn-sm btn-volver ">
          {horario}
        </button>
      ))}
    </div>
